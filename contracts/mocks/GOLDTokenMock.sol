...
/**
 * @title GOLDTokenMock token.
 * @dev GOLDTokenMock is a ERC20 token that:
 *  - has no tokens limit.
 ...
 **/
contract GOLDTokenMock is Contactable, AssetInfo, BurnableExToken, CanDelegateToken, DelegateToken, TokenWithFees, CompliantToken, WithdrawalToken, PausableToken {
